        ...
        if isinstance(msg, dict):
            ...
            if msg_type == "human":
                ...
                if tool_calls is not None:
                    formatted_messages.append(AIMessage(content=content, additional_kwargs=additional_kwargs, tool_calls=tool_calls))
                else:
                ...
                formatted_messages.append(ToolMessage(content=content, tool_call_id=tool_call_id, name=name, additional_kwargs=additional_kwargs))
